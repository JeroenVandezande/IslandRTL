...
type
  Tuple<T1> = public class({$IFNDEF NOGC}Object{$ELSE}UnmanagedObject{$ENDIF})
  public
  ...
  Tuple<T1, T2> = public class({$IFNDEF NOGC}Object{$ELSE}UnmanagedObject{$ENDIF})
  public
  ...
  Tuple<T1, T2, T3> = public class({$IFNDEF NOGC}Object{$ELSE}UnmanagedObject{$ENDIF})
  public
  ...
  Tuple<T1, T2, T3, T4> = public class({$IFNDEF NOGC}Object{$ELSE}UnmanagedObject{$ENDIF})
  public
  ...
  Tuple<T1, T2, T3, T4, T5> = public class({$IFNDEF NOGC}Object{$ELSE}UnmanagedObject{$ENDIF})
  public
  ...
  Tuple<T1, T2, T3, T4, T5, T6> = public class({$IFNDEF NOGC}Object{$ELSE}UnmanagedObject{$ENDIF})
  public
  ...
  Tuple<T1, T2, T3, T4, T5, T6, T7> = public class({$IFNDEF NOGC}Object{$ELSE}UnmanagedObject{$ENDIF})
  public
  ...
  Tuple<T1, T2, T3, T4, T5, T6, T7, T8> = public class({$IFNDEF NOGC}Object{$ELSE}UnmanagedObject{$ENDIF})
  public
